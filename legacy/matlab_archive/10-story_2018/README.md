...
- Original active path: `10-story_2018/code/matlab/`
- Archived path: `legacy/matlab_archive/10-story_2018/code/matlab/`
...
The active replacement is `10-story_2018/code/python/run_pipeline.py`. It reads
