"""Command-line entry for the 2015 raw-data-to-CSV workflow."""
...
def main() -> int:
    ...
    parser.add_argument("--analyses", nargs="+", default=None, choices=("acceleration", "displacement", "joint", "foundation", "rebar"))
    ...
    for case in cases:
        metadata = run_case(SPEC, case, args.analyses or ("acceleration", "displacement", "joint", "foundation", "rebar"))
